      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        ...
        {project && (
          <>
            ...
            <div style={box}>
              {/* GK Tiger videos are generated by the quiz pipeline, not this
                  paste-a-story form — so send the user to the generator. */}
              {channel === "gktiger" ? (
                <Link
                  href="/dashboard/channels/gktiger"
                  style={{ ...btn, background: "linear-gradient(135deg,#F57C1F,#FFC93C)", color: "#101014", width: "100%", display: "block", textAlign: "center", textDecoration: "none" }}
                >
                  🐯 Create New Quiz
                </Link>
              ) : (
