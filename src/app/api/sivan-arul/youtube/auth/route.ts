...
export async function GET(request: Request) {
  try {
    ...
    const channel = channelParam === "sanatana" ? "sanatana" : channelParam === "story" ? "story" : channelParam === "english" ? "english" : channelParam === "food" ? "food" : channelParam === "news" ? "news" : "devotional";
