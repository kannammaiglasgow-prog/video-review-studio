...
const lastStoryRunKey: Record<StoryChannel, string> = { story: "", english: "", devotional: "", news: "" };
const lastStoryShortsRunKey: Record<StoryChannel, string> = { story: "", english: "", devotional: "", news: "" };
...
function checkAndRun() {
  ...
  for (const channel of ["story", "english", "devotional", "news"] as StoryChannel[]) {
