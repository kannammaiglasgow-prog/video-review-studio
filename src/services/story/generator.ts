...
export async function generateOriginalStoryFromPremise(premise: string, language: OutputLanguage = "ta", storyId?: number): Promise<string> {
  const prompt = language === "en"
...
இந்த உணர்வுக் கருப்பொருளை மையமாக வைத்து, **முற்றிலும் புதிய, கற்பனையான** தமிழ் narration script எழுதுங்கள். புதிய பாத்திரங்கள், இடம், மற்றும் புதிய திருப்பம் கொண்ட கதையை உருவாக்குங்கள் — கருப்பொருளின் சொற்களை நேரடியாக பயன்படுத்த வேண்டாம். இது Text-to-Speech மூலம் படிக்கப்படும் YouTube கதை வீடியோவுக்கானது: முதல் இரண்டு வாக்கியங்களில் தெளிவான உணர்வுபூர்வ hook, ஏறிவரும் மோதல், திருப்திகரமான திருப்பம்/முடிவு. Emoji, hashtags, markdown வேண்டாம் — இயல்பான பேச்சு வாக்கியங்கள் மட்டும். நீளம்: சுமார் 600-900 வார்த்தைகள்.
